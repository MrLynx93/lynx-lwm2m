...
lwm2m_object *lwm2m_get_aco_object(lwm2m_context* context) {
    return lwm2m_map_get(context->object_tree->objects, ACCESS_CONTROL_OBJECT_ID);
}

lwm2m_resource_multiple* lwm2m_get_object_acl_resource(lwm2m_object* object) {
    return &(lwm2m_map_get(object->aco_instance->resources, ACL_RESOURCE_ID)->resource.resource.multiple);
}

lwm2m_resource_multiple *lwm2m_get_instance_acl_resource(lwm2m_instance *instance) {
    return &(lwm2m_map_get(instance->aco_instance->resources, ACL_RESOURCE_ID)->resource.resource.multiple);
}
...
lwm2m_resource_single *get_default_acl_resource_instance(lwm2m_context *context, lwm2m_instance* instance) {
    ...
    return lwm2m_map_get(acl_multiple_resource->instances, SECURITY_OBJECT_ID)->resource.resource.single;
}
...
int lwm2m_get_access_control_owner(lwm2m_instance *instance) {
    return lwm2m_map_get(instance->aco_instance->resources, ACO_RESOURCE_ID)->resource.resource.single.value.int_value;
}
...
lwm2m_instance *lwm2m_object_create_aco_instance(lwm2m_server* server, lwm2m_object* object) {
    ...
    lwm2m_map_get(aco_instance->resources, OBJECT_ID_RESOURCE_ID)->resource.resource.single.value.int_value = object->id;
    lwm2m_map_get(aco_instance->resources, INSTANCE_ID_RESOURCE_ID)->resource.resource.single.value.int_value = 0;
    lwm2m_map_get(aco_instance->resources, ACO_RESOURCE_ID)->resource.resource.single.value.int_value = server->short_server_id;
...
lwm2m_instance *lwm2m_instance_create_aco_instance(lwm2m_server* server, lwm2m_instance* instance) {
    lwm2m_instance* aco_instance = lwm2m_instance_new(lwm2m_get_aco_object(server->context));
    aco_instance->resources = server->context->create_standard_resources_callback(ACCESS_CONTROL_OBJECT_ID);
    lwm2m_map_get(aco_instance->resources, OBJECT_ID_RESOURCE_ID)->resource.resource.single.value.int_value = instance->object->id;
    lwm2m_map_get(aco_instance->resources, INSTANCE_ID_RESOURCE_ID)->resource.resource.single.value.int_value = instance->id;
    lwm2m_map_get(aco_instance->resources, ACO_RESOURCE_ID)->resource.resource.single.value.int_value = server->short_server_id;
    // TODO setting default ACL resource instances
    return instance;
}
